defmodule PinPayments.Refunds.Refund do
  ...
  """
  @spec create(Charge.t, map()) :: {:ok, Refund.t} | {:error, PinPayments.Error.t}
  ...
  """
  @spec get(Refund.t) :: {:ok, Refund.t} | {:error, PinPayments.Error.t}
  ...
  """
  @spec get_all() :: {:ok, [Refund.t]} | {:error, PinPayments.Error.t}
  def get_all() do
    API.get("/refunds")
    |> Response.transform(__MODULE__)
  end
  ...
  """
  @spec get_all(Integer.t) :: {:ok, [Refund.t]} | {:error, PinPayments.Error.t}
  ...
  """
  @spec get_all_for_charge(Charge.t) :: {:ok, [Refund.t]} | {:error, PinPayments.Error.t}
